...
COPY public.appointment (id, version, "createdAt", "updatedAt", type, score, price, discount, report, "isVisited", begin, "end", "patientId", "employeeId", "pharmacyId", "prescriptionId") FROM stdin;
\.
...
COPY public.appointment_definition (id, version, "createdAt", "updatedAt", type, delta, score, price, "pharmacyId") FROM stdin;
\.
...
COPY public.complaint (id, version, "createdAt", "updatedAt", description, "patientId", "pharmacyId") FROM stdin;
\.
...
COPY public.e_prescription (id, version, "createdAt", "updatedAt", "hashCode", "dateOfGrant", status, "patientId", "employeeId") FROM stdin;
\.
...
COPY public.employee (id, version, "createdAt", "updatedAt", email, password, role, "firstName", "lastName", gender, "dateOfBirth", telephone, "averageRating", "addressId", "pharmacyId") FROM stdin;
1	1	2021-02-09 20:20:01.48	2021-02-09 20:20:01.48	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N
2	1	2021-02-09 20:20:08.244	2021-02-09 20:20:08.244	sysadmin@mail	admin	sysadmin	\N	\N	\N	\N	\N	0	\N	\N
\.
...
COPY public.holiday (id, version, "createdAt", "updatedAt", "from", until, "isApproved", "employeeId") FROM stdin;
\.
...
COPY public.medicine (id, version, "createdAt", "updatedAt", code, name, type, points, form, contents, producer, rating, "isPrescriptionRequired", info, "from", until) FROM stdin;
\.
...
COPY public.medicine_item (id, version, "createdAt", "updatedAt", quantity, price, "dateOfPurchase", instructions, "detailsId", "listId") FROM stdin;
\.
...
COPY public.patient (id, version, "createdAt", "updatedAt", email, password, role, "firstName", "lastName", gender, "dateOfBirth", telephone, score, penalty, "isEnabled", "addressId", "tierId") FROM stdin;
\.
...
COPY public.rating (id, version, "createdAt", "updatedAt", complain, "patientId", "employeeId", "pharmacyId") FROM stdin;
\.
...
COPY public.reservation (id, version, "createdAt", "updatedAt", deadline, "pickupDate", "isBought", "totalSum", "pharmacyId", "patientId") FROM stdin;
\.
...
COPY public."user" (id, version, "createdAt", "updatedAt", email, password, role, "firstName", "lastName", gender, "dateOfBirth", telephone, "addressId") FROM stdin;
\.
...
COPY public.working_hours (id, version, "createdAt", "updatedAt", "pharmacyID", "from", until, "employeeId") FROM stdin;
\.
...
SELECT pg_catalog.setval('public.medicine_item_id_seq', 1, false);
