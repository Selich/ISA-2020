...
let inputs = {
     ...
     "score": 2,
     "kind": "pharm",
     "begin": "2021-07-01T12:00:00.000Z"
}
let token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiZW1haWwiOiJzZWxpY2gud29ya0BnbWFpbC5jb20iLCJyb2xlIjoicGF0aWVudCIsImlhdCI6MTYyMjgzODc2NiwiZXhwIjoxNjIyODM5OTY2fQ.s8Tn_TBjUIyWgNl0gEa8SxXbg-qyMmnULBl3nZzRUQ4"

const query = `
mutation ScheduleConsultation(
  $inputs:AppointmentInput!,
  $token:String!
) {
  scheduleConsultation(${inputs}, ${token}){
...
// @ts-ignore
describe('Consultations Test', () => {
  // @ts-ignore
  test("Schedule Consultation", async () => {
    ...
    // @ts-ignore
    expect(inputs).toMatchObject(inputs);
