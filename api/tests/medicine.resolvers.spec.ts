...
// @ts-ignore
describe('Medicines Test', () => {
  // @ts-ignore
  test("Medicines", async () => {
    ...
    // @ts-ignore
    expect(res.data.medicines).toMatchObject(original);
    // const result = await conn.query(`SELECT * FROM medicine WHERE id=1`)
    // // @ts-ignore
...
let original = [
  {
    ...
    "name": "Aspirin",
    "code": "1",
    "info": "Aspirin, also known as acetylsalicylic acid, is a medication used to reduce pain, fever, or inflammation. ",
    "kind": "Tablet",
    "points": 3,
    "form": "Tablet",
    "contents": "Each tablet contains Aspirin 325 mg Aspirin (Acetysalicylic Acid) 325 mg (5gr.) (NSAID)*"
  }
]